...
export default function ViewLand({ active }: { active: boolean }) {
  return (
    <svg
      width="22"
      height="22"
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_251_151)"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      <path
        ...
        stroke="url(#paint1_linear_251_151)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        ...
        stroke="url(#paint2_linear_251_151)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
